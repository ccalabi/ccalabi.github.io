...
var leftButton = document.getElementById('mazeLeft');
var upButton = document.getElementById('mazeUp');
var rightButton = document.getElementById('mazeRight');
var downButton = document.getElementById('mazeDown');
//Loads up the game
var w = window,
    d = document,
    e = d.documentElement,
...
//Changing the color and size of the balls
    ...
    leftButton.onclick = function() { moveWest(); };
    upButton.onclick = function() { moveNorth(); };
    rightButton.onclick = function() { moveEast(); };
    downButton.onclick = function() { moveSouth(); };
